...
# --- CONFIGURATION ---
INPUT_FILE = "Berries_Separated_Sheets_Neg.xlsx"      # Multi-sheet excel file
OUTPUT_FILE = "Berries_With_Dynamic_Classifications_Negative.xlsx" # Final annotated output file
