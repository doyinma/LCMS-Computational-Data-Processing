...
# --- CONFIGURATION ---
INPUT_FILE = "Berry_ExportedCompounds_Features_MS2_Neg.xlsx"  # Change to your actual file name
OUTPUT_FILE = "Berry_Extracted_MS2_Fragments_Negative.xlsx"    # Final flat output file
