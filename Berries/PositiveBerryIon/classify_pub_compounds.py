...
# --- CONFIGURATION ---
INPUT_FILE = "Berries_Separated_Sheets_Pos.xlsx"      # Multi-sheet excel file
OUTPUT_FILE = "Berries_With_Dynamic_Classifications_Positive.xlsx" # Final annotated output file
