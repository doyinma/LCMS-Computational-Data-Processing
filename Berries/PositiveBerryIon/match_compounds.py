...
# --- CONFIGURATION ---
COMPOUNDS_FILE = "Berry_Comps_Pos_Perfect_Output.xlsx"  # The file we just generated
BERRY_MAPPING_FILE = "Study_Info_Berry_Pos_Filtered.xlsx"       # File containing the mapping of Study File IDs to Berry types
OUTPUT_FILE = "Pos_Matched_Berry_Report.xlsx"
