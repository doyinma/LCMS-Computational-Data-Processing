...
# --- CONFIGURATION ---
CLASSIFIED_VEG_FILE = "Berries_With_Dynamic_Classifications_Positive.xlsx"  # Multi-sheet classified workbook
EXTRACTED_MS2_FILE = "Berry_Extracted_MS2_Fragments_Positive.xlsx"          # Flat file from previous script
OUTPUT_FINAL_FILE = "(Positive) Classified_Berries_With_MS2_Positive.xlsx"         # Final annotated output workbook
