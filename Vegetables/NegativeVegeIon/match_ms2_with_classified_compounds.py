...
# --- CONFIGURATION ---
CLASSIFIED_VEG_FILE = "Vegetables_With_Dynamic_Classifications.xlsx"  # Multi-sheet classified workbook
EXTRACTED_MS2_FILE = "Extracted_MS2_Fragments.xlsx"          # Flat file from previous script
OUTPUT_FINAL_FILE = "Classified_Vegetables_With_MS2.xlsx"         # Final annotated output workbook
