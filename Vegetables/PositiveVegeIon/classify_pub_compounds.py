...
# --- CONFIGURATION ---
INPUT_FILE = "Vegetables_Separated_Sheets_Positive.xlsx"      # Multi-sheet excel file
OUTPUT_FILE = "Vegetables_With_Dynamic_Classifications_Positive.xlsx" # Final annotated output file
